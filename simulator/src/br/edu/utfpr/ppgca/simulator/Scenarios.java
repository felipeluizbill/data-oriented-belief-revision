...
public class Scenarios {
	...
	final int ENVIRONMENT_PROPORTION[] = { 10, 100, 1000 };
	...
	public void generalScenario() {
		...
		runExperiment(AMOUNT_OF_GOALS[1], ENVIRONMENT_SIZE, RULES_PER_GOAL[0], MEMORY_SIZE, STORING_THRESHOLDS[2],
				RETRIEVING_THRESHOLDS[2], OBLIVION_THRESHOLDS[2], DYNAMICS[0]);
	}
